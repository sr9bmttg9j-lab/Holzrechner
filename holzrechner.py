...
M3_PRICES_BY_LEVEL = {
    1: [Decimal("265"), Decimal("303"), Decimal("353"), Decimal("410"), Decimal("517"), Decimal("618")],
    2: [Decimal("290"), Decimal("340"), Decimal("403"), Decimal("479"), Decimal("599"), Decimal("744")],
    3: [Decimal("328"), Decimal("391"), Decimal("479"), Decimal("580"), Decimal("725"), Decimal("914")],
}
...
RUNNING_METER_PRICES_BY_LEVEL = {
    1: [Decimal("3.75"), Decimal("4.38"), Decimal("5.01"), Decimal("5.64"), Decimal("6.90")],
    2: [Decimal("4.38"), Decimal("5.01"), Decimal("6.27"), Decimal("8.16"), Decimal("10.05")],
    3: [Decimal("5.64"), Decimal("6.90"), Decimal("8.79"), Decimal("10.68"), Decimal("14.46")],
}
...
PANEL_M2_PRICES_BY_LEVEL = {
    1: [Decimal("7.53"), Decimal("9.42"), Decimal("12.57"), Decimal("15.72"), Decimal("22.03")],
    2: [Decimal("9.42"), Decimal("12.57"), Decimal("18.88"), Decimal("25.18"), Decimal("34.63")],
    3: [Decimal("12.57"), Decimal("18.88"), Decimal("28.33"), Decimal("37.78"), Decimal("50.39")],
}
...
ORDER_EK_VALUES_BY_LEVEL = {
    1: [Decimal("176"), Decimal("265"), Decimal("353"), Decimal("473"), Decimal("567")],
    2: [Decimal("230"), Decimal("369"), Decimal("479"), Decimal("618"), Decimal("788")],
    3: [Decimal("301"), Decimal("437"), Decimal("514"), Decimal("750"), Decimal("971")],
}
...
def m3_price_for_product(product, level):
    ...
    pools = {
        "KVH": {
            1: [Decimal("265"), Decimal("290"), Decimal("328"), Decimal("366")],
            2: [Decimal("290"), Decimal("328"), Decimal("366"), Decimal("410")],
            3: [Decimal("328"), Decimal("372"), Decimal("416"), Decimal("466")],
        },
        "BSH": {
            1: [Decimal("454"), Decimal("517"), Decimal("580"), Decimal("655")],
            2: [Decimal("492"), Decimal("561"), Decimal("643"), Decimal("731")],
            3: [Decimal("542"), Decimal("618"), Decimal("725"), Decimal("832")],
        },
        "KERTO": {
            1: [Decimal("580"), Decimal("681"), Decimal("782")],
            2: [Decimal("655"), Decimal("769"), Decimal("895")],
            3: [Decimal("744"), Decimal("870"), Decimal("1021"), Decimal("1160")],
        },
        "Hobelware": {
            1: [Decimal("479"), Decimal("580"), Decimal("681")],
            2: [Decimal("561"), Decimal("681"), Decimal("807")],
            3: [Decimal("655"), Decimal("794"), Decimal("933"), Decimal("1084")],
        },
        "OSB-Platte": {
            1: [Decimal("328"), Decimal("391"), Decimal("454")],
            2: [Decimal("366"), Decimal("429"), Decimal("517")],
            3: [Decimal("403"), Decimal("479"), Decimal("580")],
        },
        "Siebdruckplatte": {
            1: [Decimal("945"), Decimal("1103"), Decimal("1292")],
            2: [Decimal("1059"), Decimal("1248"), Decimal("1462")],
            3: [Decimal("1172"), Decimal("1387"), Decimal("1639")],
        },
        "3-Schicht-Platte": {
            1: [Decimal("618"), Decimal("744"), Decimal("870")],
            2: [Decimal("706"), Decimal("857"), Decimal("996")],
            3: [Decimal("807"), Decimal("958"), Decimal("1147")],
        },
        "Dekorplatte": {
            1: [Decimal("599"), Decimal("744"), Decimal("895")],
            2: [Decimal("681"), Decimal("832"), Decimal("996")],
            3: [Decimal("769"), Decimal("933"), Decimal("1122")],
        },
        "Dekorspanplatte": {
            1: [Decimal("479"), Decimal("580"), Decimal("706")],
            2: [Decimal("555"), Decimal("681"), Decimal("832")],
            3: [Decimal("643"), Decimal("782"), Decimal("958")],
        },
        "Multiplexplatte Birke": {
            1: [Decimal("1071"), Decimal("1292"), Decimal("1513")],
            2: [Decimal("1197"), Decimal("1450"), Decimal("1702")],
            3: [Decimal("1355"), Decimal("1639"), Decimal("1922")],
        },
        "Tischlerplatte": {
            1: [Decimal("756"), Decimal("914"), Decimal("1059")],
            2: [Decimal("870"), Decimal("1021"), Decimal("1197")],
            3: [Decimal("983"), Decimal("1166"), Decimal("1374")],
        },
        "Leimholzplatte": {
            1: [Decimal("693"), Decimal("832"), Decimal("996")],
            2: [Decimal("807"), Decimal("958"), Decimal("1147")],
            3: [Decimal("914"), Decimal("1122"), Decimal("1361")],
        },
        "Sperrholzplatte": {
            1: [Decimal("618"), Decimal("744"), Decimal("914")],
            2: [Decimal("706"), Decimal("870"), Decimal("1059")],
            3: [Decimal("807"), Decimal("996"), Decimal("1229")],
        },
    }
...
def panel_m2_price_for_product(product, level):
    ...
    pools = {
        "OSB-Platte": {
            1: [Decimal("7.53"), Decimal("8.85"), Decimal("10.68")],
            2: [Decimal("8.85"), Decimal("11.94"), Decimal("15.72")],
            3: [Decimal("11.94"), Decimal("15.72"), Decimal("20.77")],
        },
        "Siebdruckplatte": {
            1: [Decimal("25.18"), Decimal("28.66"), Decimal("33.37")],
            2: [Decimal("28.66"), Decimal("35.89"), Decimal("43.46")],
            3: [Decimal("33.37"), Decimal("43.46"), Decimal("53.54")],
        },
        "3-Schicht-Platte": {
            1: [Decimal("22.03"), Decimal("27.07"), Decimal("34.63")],
            2: [Decimal("27.07"), Decimal("34.63"), Decimal("43.46")],
            3: [Decimal("34.63"), Decimal("43.46"), Decimal("53.54")],
        },
        "Dekorplatte": {
            1: [Decimal("15.72"), Decimal("18.88"), Decimal("23.29")],
            2: [Decimal("18.88"), Decimal("25.18"), Decimal("31.48")],
            3: [Decimal("25.18"), Decimal("31.48"), Decimal("40.93")],
        },
        "Dekorspanplatte": {
            1: [Decimal("10.68"), Decimal("14.46"), Decimal("18.88")],
            2: [Decimal("14.46"), Decimal("18.88"), Decimal("25.18")],
            3: [Decimal("18.88"), Decimal("25.18"), Decimal("34.63")],
        },
        "Multiplexplatte Birke": {
            1: [Decimal("28.33"), Decimal("33.53"), Decimal("39.39")],
            2: [Decimal("33.53"), Decimal("39.39"), Decimal("44.09")],
            3: [Decimal("39.39"), Decimal("44.09"), Decimal("53.54")],
        },
        "Tischlerplatte": {
            1: [Decimal("22.03"), Decimal("28.33"), Decimal("34.63")],
            2: [Decimal("28.33"), Decimal("34.63"), Decimal("40.93")],
            3: [Decimal("34.63"), Decimal("40.93"), Decimal("50.39")],
        },
        "Leimholzplatte": {
            1: [Decimal("18.88"), Decimal("25.18"), Decimal("31.48")],
            2: [Decimal("25.18"), Decimal("34.63"), Decimal("44.09")],
            3: [Decimal("34.63"), Decimal("44.09"), Decimal("56.69")],
        },
        "Sperrholzplatte": {
            1: [Decimal("15.72"), Decimal("20.77"), Decimal("25.18")],
            2: [Decimal("20.77"), Decimal("25.18"), Decimal("31.48")],
            3: [Decimal("25.18"), Decimal("31.48"), Decimal("40.93")],
        },
    }
...
def render_development_section():
    ...
    with st.expander("Was war der praktische Hintergrund im Holzhandel?"):
        st.write(
            ...
            "kommen Laufmeter, Quadratmeter, Kubikmeter, Stückzahlen, Paketmengen, Einkaufspreise, Verkaufspreise und "
            "Deckungsbeitrag zusammen. Sobald Maßeinheiten gemischt werden, zum Beispiel Millimeter, Zentimeter und Meter, "
            "entstehen typische Fehler durch fehlende Faktoren, falsche Rechenrichtung oder falsch gesetzte Kommastellen."
        )
        st.write(
            "Der KI-Holzrechner wurde deshalb nicht als klassischer Taschenrechner gebaut, sondern als Übungswerkzeug. "
            "Man soll nicht nur irgendein Endergebnis eintippen, sondern den Rechenweg verstehen, Fehler erkennen und die "
            "Logik so oft wiederholen können, bis sie sicher sitzt."
        )

    with st.expander("Welche Produkte stecken im KI-Holzrechner?"):
        st.write(
            "Im Hintergrund sind verschiedene Produktgruppen aus dem Holzhandel angelegt. Dazu gehören Konstruktionsholz wie "
            "KVH, BSH und KERTO, Hobelware und Glattkantbretter, Profilbretter mit Rohmaß und Deckbreite, Plattenware wie "
            "OSB-Platte, Dekorspanplatte, Siebdruckplatte, 3-Schicht-Platte, Dekorplatte, Multiplexplatte Birke, "
            "Tischlerplatte, Leimholzplatte und Sperrholzplatte. Zusätzlich gibt es Bodenprodukte wie Eiche-Massivholzdiele, "
            "Parkett, Fertigparkett, Laminat und Vinylboden sowie Holzfaser-Einblasdämmung."
        )
        st.write(
            "Zu diesen Produkten sind typische Maße hinterlegt. Konstruktionshölzer werden mit Längen und Querschnitten "
            "gerechnet, Hobelware mit Längen, Breiten und Stärken in Millimetern, Platten mit Format und Plattenstärke, "
            "Boden mit Dielenmaßen und Paketstückzahlen. Bei Profilbrettern wird zusätzlich zwischen Rohbreite und Deckbreite "
            "unterschieden, weil durch Nut und Feder sichtbare Fläche verloren geht."
        )
    ...
    with st.expander("Welche Rechenwege und Aufgabentypen werden geübt?"):
        ...
        st.write(
            "Darüber hinaus gibt es Aufgaben mit Paketlogik. Bei Bodenpaketen, Bundware oder Stückware muss eine rechnerische "
            "Menge auf volle Pakete, Bund oder Stück aufgerundet werden. Der Rechner zeigt dann nicht nur das gerundete Ergebnis, "
            "sondern erklärt auch, welcher Rohwert auf welchen vollen Wert aufgerundet wurde."
        )
        st.write(
            "Ein weiterer Bereich ist die Kalkulation. Der Rechner übt Einkaufspreis, Verkaufspreis, absoluten Deckungsbeitrag "
            "und relativen Deckungsbeitrag. Dabei gibt es Aufgaben in beide Richtungen: Aus einem Einkaufspreis und Ziel-DB "
            "wird ein Verkaufspreis berechnet, aus einem Verkaufspreis und DB wird zurück auf den Einkaufspreis gerechnet, "
            "und aus Einkaufspreis und Verkaufspreis wird der Rohertrag beziehungsweise DB-Satz ermittelt."
        )
        st.write(
            "Außerdem gibt es Aufgaben zu Dichte und Gewicht, zum Beispiel bei Holzprodukten oder Holzfaser-Einblasdämmung. "
    ...
    with st.expander("Wie wurden realistischere Preisniveaus eingebaut?"):
        ...
        st.write(
            ...
            "im Handel häufig genau so ausgezeichnet wird. Weil viele öffentlich sichtbare Online-Preise eher Brutto-Endkundenpreise "
            "sind, wurden die Übungswerte zusätzlich auf ein niedrigeres internes Preisniveau heruntergerechnet: grob netto "
            "bereinigt und anschließend noch einmal um 25 Prozent reduziert. Die Werte sind damit realitätsnäher, bleiben aber "
            "weiterhin Übungswerte und können sich im echten Handel je nach Lieferant, Region, Qualität und Zeitpunkt deutlich verändern."
        )
    ...
    with st.expander("Welche Technik steckt dahinter?"):
        st.write(
            "Die App ist in Python geschrieben und läuft mit Streamlit. Streamlit erzeugt aus der Python-Datei eine Weboberfläche, "
            "die lokal getestet und öffentlich bereitgestellt werden kann. Git und GitHub werden genutzt, um Änderungen sauber "
            "zu speichern und die Streamlit-App zu aktualisieren."
        )
        st.write(
            "Wenn lokal etwas geändert wird, wird es getestet, als Commit gespeichert und anschließend zu GitHub gepusht. "
            "Streamlit Cloud kann daraus automatisch die öffentliche App aktualisieren. So bleibt der Entwicklungsprozess "
    ...
    with st.expander("Wie wurde der KI-Holzrechner entwickelt?"):
        ...
        st.write(
            ...
            "inhaltlich stimmen muss, und Codex hilft dabei, daraus eine App zu bauen. Das funktioniert besonders gut, wenn jede "
            "Änderung klein genug bleibt, getestet wird und fachliches Feedback direkt wieder in die nächste Version einfließt."
        )
    ...
    with st.expander("Wo liegen Grenzen und mögliche Weiterentwicklungen?"):
        st.write(
            "Der KI-Holzrechner ist aktuell vor allem für Desktop-PCs, Laptops und größere Tablets gedacht. Auf dem Handy "
            "funktioniert die App grundsätzlich, aber Formeln, Zwischenschritte und Musterlösungen sind dort weniger übersichtlich."
        )
        st.write(
            "Fachlich kann der Rechner weiter wachsen: zusätzliche Produkte, weitere Kalkulationsarten, neue Fehlerdiagnosen, "
